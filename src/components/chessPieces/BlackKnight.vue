<template>
    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="45" height="45">
        <g transform="rotate(180,22.5,22.5)" style="opacity:1; fill:none; fill-opacity:1; fill-rule:evenodd; stroke:#000000; stroke-width:1.5; stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:4; stroke-dasharray:none; stroke-opacity:1;">
